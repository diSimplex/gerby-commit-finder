# test_benchmark[bib.tex]

## Test failure

```
___________________________ test_benchmark[bib.tex] ____________________________

src = PosixPath('/home/stg/tmp/gerby-plastex/b/unittests/Packages/sources/bib.tex')
tmpdir = PosixPath('/tmp/pytest-of-stg/pytest-2/test_benchmark_bib_tex_0')
...
E                stg/pytest-2/test_benchmark_bib_tex_0.
...
E              [ bib.html ]plasTeX version 3.1
E
E
