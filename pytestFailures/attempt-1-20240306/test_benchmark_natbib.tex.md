# test_benchmark[natbib.tex]

## Test failure

```
__________________________ test_benchmark[natbib.tex] __________________________

src = PosixPath('/home/stg/tmp/gerby-plastex/b/unittests/Packages/sources/natbib.tex')
tmpdir = PosixPath('/tmp/pytest-of-stg/pytest-2/test_benchmark_natbib_tex_0')
...
E                stg/pytest-2/test_benchmark_natbib_tex_0.
...
E              [ natbib.html ]plasTeX version 3.1
E
E
